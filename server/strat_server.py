...
GAME_METADATA = {
    ...
    't3alam':          {'id':'t3alam','name':'رحلة الحروف','genre':'Éducatif','icon':'🦁','url':'https://huruf.pixelsoftwaredesign.xyz','desc':"رِحْلَةُ تَعَلُّمِ الْعَرَبِيَّةِ مِنَ الْأَلِفِ إِلَى الْيَاءِ — Apprends l'arabe de l'alif au ya : lettres, mots, phrases, prononciation, monde 3D et réalité augmentée.",'tags':['Arabe','Enfants','3D','AR']},
